...
SUBCASE("base functions")
{
    ...
    CHECK(xi (647.35, 122.) == Approx {  0.309247e-9 }.scale (1e-9).epsilon (1e-8));
    CHECK(xi (647.35, 222.) == Approx {  1.571405e-9 }.scale (1e-9).epsilon (1e-8));
    CHECK(xi (647.35, 272.) == Approx {  5.266522e-9 }.scale (1e-9).epsilon (1e-8));
    CHECK(xi (647.35, 322.) == Approx { 16.590209e-9 }.scale (1e-8).epsilon (1e-8));
    CHECK(xi (647.35, 372.) == Approx {  5.603768e-9 }.scale (1e-9).epsilon (1e-8));
    CHECK(xi (647.35, 422.) == Approx {  1.876244e-9 }.scale (1e-9).epsilon (1e-8));

