...
TEST_CASE("r7.hpp (relaxed)")
{
    ...
    SUBCASE("iapws-r7-region-3")
    {
        ...
        CHECK(t_3ab_p (40.0e6) == Approx { 6.930341408e2 }.scale (1e2).epsilon (eps));
        CHECK(t_3cd_p (25.0e6) == Approx { 6.493659208e2 }.scale (1e2).epsilon (eps));
        CHECK(t_3ef_p (40.0e6) == Approx { 7.139593992e2 }.scale (1e2).epsilon (eps));
        CHECK(t_3gh_p (23.0e6) == Approx { 6.498873759e2 }.scale (1e2).epsilon (eps));
        CHECK(t_3ij_p (23.0e6) == Approx { 6.515778091e2 }.scale (1e2).epsilon (eps));
        CHECK(t_3jk_p (23.0e6) == Approx { 6.558338344e2 }.scale (1e2).epsilon (eps));
        CHECK(t_3mn_p (22.8e6) == Approx { 6.496054133e2 }.scale (1e2).epsilon (eps));
        CHECK(t_3op_p (22.8e6) == Approx { 6.500106943e2 }.scale (1e2).epsilon (eps));
        CHECK(t_3qu_p (22.0e6) == Approx { 6.456355027e2 }.scale (1e2).epsilon (eps));
        CHECK(t_3rx_p (22.0e6) == Approx { 6.482622754e2 }.scale (1e2).epsilon (eps));
        CHECK(t_3uv_p (22.3e6) == Approx { 6.477996121e2 }.scale (1e2).epsilon (eps));
        CHECK(t_3wx_p (22.3e6) == Approx { 6.482049480e2 }.scale (1e2).epsilon (eps));

        CHECK(detail::region_pt (50.0e6,   630.00) == detail::a);
        CHECK(detail::region_pt (80.0e6,   670.00) == detail::a);
        CHECK(detail::region_pt (50.0e6,   710.00) == detail::b);
        CHECK(detail::region_pt (80.0e6,   750.00) == detail::b);
        CHECK(detail::region_pt (20.0e6,   630.00) == detail::c);
        CHECK(detail::region_pt (30.0e6,   650.00) == detail::c);
        CHECK(detail::region_pt (26.0e6,   656.00) == detail::d);
        CHECK(detail::region_pt (30.0e6,   670.00) == detail::d);
        CHECK(detail::region_pt (26.0e6,   661.00) == detail::e);
        CHECK(detail::region_pt (30.0e6,   675.00) == detail::e);
        CHECK(detail::region_pt (26.0e6,   671.00) == detail::f);
        CHECK(detail::region_pt (30.0e6,   690.00) == detail::f);
        CHECK(detail::region_pt (23.6e6,   649.00) == detail::g);
        CHECK(detail::region_pt (24.0e6,   650.00) == detail::g);
        CHECK(detail::region_pt (23.6e6,   652.00) == detail::h);
        CHECK(detail::region_pt (24.0e6,   654.00) == detail::h);
        CHECK(detail::region_pt (23.6e6,   653.00) == detail::i);
        CHECK(detail::region_pt (24.0e6,   655.00) == detail::i);
        CHECK(detail::region_pt (23.5e6,   655.00) == detail::j);
        CHECK(detail::region_pt (24.0e6,   660.00) == detail::j);
        CHECK(detail::region_pt (23.0e6,   660.00) == detail::k);
        CHECK(detail::region_pt (24.0e6,   670.00) == detail::k);
        CHECK(detail::region_pt (22.6e6,   646.00) == detail::l);
        CHECK(detail::region_pt (23.0e6,   646.00) == detail::l);
        CHECK(detail::region_pt (22.6e6,   648.60) == detail::m);
        CHECK(detail::region_pt (22.8e6,   649.30) == detail::m);
        CHECK(detail::region_pt (22.6e6,   649.00) == detail::n);
        CHECK(detail::region_pt (22.8e6,   649.70) == detail::n);
        CHECK(detail::region_pt (22.6e6,   649.10) == detail::o);
        CHECK(detail::region_pt (22.8e6,   649.90) == detail::o);
        CHECK(detail::region_pt (22.6e6,   649.40) == detail::p);
        CHECK(detail::region_pt (22.8e6,   650.20) == detail::p);
        CHECK(detail::region_pt (21.1e6,   640.00) == detail::q);
        CHECK(detail::region_pt (21.8e6,   643.00) == detail::q);
        CHECK(detail::region_pt (21.1e6,   644.00) == detail::r);
        CHECK(detail::region_pt (21.8e6,   648.00) == detail::r);
        CHECK(detail::region_pt (19.1e6,   635.00) == detail::s);
        CHECK(detail::region_pt (20.0e6,   638.00) == detail::s);
        CHECK(detail::region_pt (17.0e6,   626.00) == detail::t);
        CHECK(detail::region_pt (20.0e6,   640.00) == detail::t);
        CHECK(detail::region_pt (21.5e6,   644.60) == detail::u);
        CHECK(detail::region_pt (22.0e6,   646.10) == detail::u);
        CHECK(detail::region_pt (22.5e6,   648.60) == detail::v);
        CHECK(detail::region_pt (22.3e6,   647.90) == detail::v);
        CHECK(detail::region_pt (22.15e6,  647.50) == detail::w);
        CHECK(detail::region_pt (22.3e6,   648.10) == detail::w);
        CHECK(detail::region_pt (22.11e6,  648.00) == detail::x);
        CHECK(detail::region_pt (22.3e6,   649.00) == detail::x);
        CHECK(detail::region_pt (22.0e6,   646.84) == detail::y);
        CHECK(detail::region_pt (22.064e6, 647.05) == detail::y);
        CHECK(detail::region_pt (22.0e6,   646.89) == detail::z);
        CHECK(detail::region_pt (22.064e6, 647.15) == detail::z);
